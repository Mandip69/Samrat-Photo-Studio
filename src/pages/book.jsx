...
export default function BookNow() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(formData); // Replace with API or backend integration
  ...
  return (
    <section className="min-h-screen bg-gray-900 py-24 px-6 md:px-16 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10 text-center">
        ...
        >
          Fill in the details below to schedule your photography session or other services. We'll get back to you shortly to confirm your booking.
        </motion.p>
